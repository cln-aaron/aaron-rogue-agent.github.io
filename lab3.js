(() => {
  ...
  function writeCmd(cmd) {
    writeRaw('<span class="prompt-line">user@dc34:~/multi-agent-system$</span> ' + escapeHtml(cmd), 'cmd');
  }
  ...
  function banner() {
    write('DEFCON 2026 · LLM Vulnerability Lab — Lab 03: Agentic Kill Chain', 'ok');
    write('-----------------------------------------------------------------', 'muted');
